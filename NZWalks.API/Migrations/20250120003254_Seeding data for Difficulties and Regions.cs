    ...
    public partial class SeedingdataforDifficultiesandRegions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("cf3f47c9-a345-4e2f-8ccf-3ae1c10ac418"), "Hard" },
                    { new Guid("d988f4dc-86cf-4be4-a469-0080abcd6864"), "Medium" },
                    { new Guid("f0db9573-0637-4272-880b-6e1415f80395"), "Easy" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("cf3f47c9-a345-4e2f-8ccf-3ae1c10ac418"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("d988f4dc-86cf-4be4-a469-0080abcd6864"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("f0db9573-0637-4272-880b-6e1415f80395"));
